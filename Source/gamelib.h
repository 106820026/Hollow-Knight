...
namespace game_framework {
	...
	public:
		...
		void  OnMove();					// 依頻率更換bitmap (慢)
		void  OnMove2();				// 依頻率更換bitmap (快)
		void  OnShow();					// 將動畫貼到螢幕
	...
	class CGameStateRun;
	class CGameStateRun1;
	class CGameStateRun1_2;
	class CGameStateWin;
	...
	public:
		...
		static  int  initialize;								// 使否要初始化(1要,0不要)
		static	int  level;										// 第幾關
	...
	private:
		...
		const int		NUM_GAME_STATES;	// 遊戲的狀態數(9個狀態)
